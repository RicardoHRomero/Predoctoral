...
Por otro lado, la física de los sistemas cuánticos abiertos y fuera del equilibrio ha adquirido una relevancia creciente en las últimas décadas, al ofrecer un marco unificado para describir fenómenos en una amplia variedad de plataformas, que van desde átomos fríos y condensados de Bose–Einstein hasta sistemas de materia condensada y óptica cuántica~\cite{rotter2015}.
A diferencia de los sistemas cerrados, cuya evolución temporal está gobernada únicamente por un Hamiltoniano conservativo, los sistemas abiertos interactúan de manera inevitable con su entorno, lo que introduce mecanismos de disipación, ruido y pérdida de coherencia~\cite{Sieberer2016}. Esta interacción con el medio externo altera profundamente la dinámica del sistema, dando lugar a estados estacionarios que no pueden describirse mediante estados puros, sino mediante mezclas cuánticas representadas por operadores de densidad~\cite{breuer2003}.
...
Un ejemplo paradigmático de este tipo de fenómenos es el modelo de Dicke abierto, donde la pérdida fotónica y el bombeo atómico compiten con el acoplamiento coherente luz–materia. Experimentos con condensados de Bose–Einstein en cavidades ópticas demostraron que la transición superradiante puede realizarse y mantenerse en un régimen no térmico (Cita[Baumann et al., 2010]; Cita[Klinder et al., 2015]). En circuit QED, configuraciones análogas han permitido observar dinámicas colectivas estacionarias inducidas por disipación (Cita[Le Boité et al., 2013]; Cita[Blais et al., 2021]). Estos resultados marcaron un cambio de paradigma: la disipación dejó de considerarse un mecanismo puramente destructivo para convertirse en un elemento activo capaz de generar y estabilizar el orden cuántico colectivo. En tales escenarios, la apertura del sistema introduce nuevas escalas de tiempo, modifica la criticidad e incluso da lugar a fases dinámicas emergentes, como oscilaciones coherentes sostenidas o cristales de tiempo (Cita[Minganti et al., 2018]; Cita[Mivehvar et al., 2021]; Cita[Zhu et al., 2019]).





La historia de estos modelos abiertos refleja la evolución conceptual de la física cuántica moderna: desde la búsqueda de coherencia en sistemas aislados hacia la comprensión del papel creativo del entorno. El modelo de Rabi abierto representa el laboratorio teórico ideal para estudiar los mecanismos microscópicos de la decoherencia y el entrelazamiento disipativo, mientras que el modelo de Dicke abierto capta el surgimiento de fenómenos colectivos bajo condiciones fuera del equilibrio. En ambos casos, las observaciones experimentales y los desarrollos teóricos han revelado que los efectos ambientales pueden inducir autoorganización cuántica, retroalimentación colectiva y transiciones de fase dinámicas (Cita[Kirton et al., 2019]; Cita[Forn-Díaz et al., 2019]).
...
En información cuántica, los mecanismos de \textit{reservoir engineering} se utilizan para proteger estados entrelazados frente al ruido y para estabilizar memorias cuánticas persistentes (Cita[Fiorelli et al., 2020]). En el ámbito de la simulación cuántica, los modelos de Dicke abiertos permiten emular fenómenos de materia condensada, como transiciones de fase o formación de fases coherentes impulsadas por disipación (Cita[Mivehvar et al., 2021]). Además, los sistemas multiqubit y multimodo ofrecen una plataforma natural para explorar arquitecturas híbridas de redes neuronales cuánticas, en las que la interacción entre modos del campo codifica patrones de memoria distribuidos (Cita[Marsch et al., 2021]). Estas aplicaciones muestran que la comprensión de la dinámica fuera del equilibrio no es sólo fundamental, sino estratégica para las tecnologías cuánticas emergentes.
...
El siguiente paso de esta investigación es extender los modelos de Rabi y Dicke abiertos a escenarios multiqubit y multimodo, donde los emisores interactúan simultáneamente con varios modos del campo. Esto permite estudiar la cooperación y competencia entre modos en la formación de fases superradiantes y patrones colectivosCita[Fiorelli et al., 2020]Cita[Carollo et al., 2021]), así como los efectos de correlación entre emisores, esenciales para el entrelazamiento y la autoorganización cuántica(Cita[Garraway, 2011]).
La inclusión de disipación y multifrecuencia abre la puerta a nuevas fases estacionarias no térmicas, donde la coherencia colectiva se reorganiza bajo la influencia del entorno. La tesis propone un enfoque progresivo: iniciar con el modelo de Rabi para dos qubits, verificable numéricamente, y avanzar hacia el régimen colectivo multimodal del modelo de Dicke abierto, incorporando bombeo, disipación y efectos no–Markovianos. Este camino permitirá comprender cómo la interacción entre coherencia, disipación y multimodalidad genera nuevas formas de criticidad y autoorganización cuántica(Cita[Marsch et al., 2021]; Cita[Rotondo et al., 2015])., con implicaciones directas en el desarrollo de dispositivos cuánticos funcionales.
